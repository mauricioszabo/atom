(ns atom.view-lib
  (:require [promesa.core :as p]
            [atom.text-editor :refer [TextEditor set-editor!]]
...
(def TE (doto AtomTextEditor
              (.setClipboard "")))
#_(new TE #js {})
(def get-load-fn (js/require "../src/get-window-load-settings"))
; (prn :LOL TextEditor)
...
(defn setLoadTime [loadTime]
  (if (.-atom js/global)
    ...
    (set! (.-atom js/global) #js {:loadTime loadTime})))
